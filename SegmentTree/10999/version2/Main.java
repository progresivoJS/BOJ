...
public class Main
{
    ...
    private static class SegmentTree
    {
        ...
        // [a, b]에 diff를 더하라.
        public long update(int a, int b, int diff)
        {
            return update(a, b, diff, 1, 0, n - 1);
        }
        
        private long update(int a, int b, int diff, int v, int na, int nb)
        {
            propagate(v, na, nb);
            ...
            int mid = (na + nb) / 2;
            return tree[v] = update(a, b, diff, 2 * v, na, mid) + update(a, b, diff, 2 * v + 1, mid + 1, nb);
        }
